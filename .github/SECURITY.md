...
The Notification Service is an event-driven microservice responsible for handling all notification delivery across the xshopai platform, including email, SMS, push notifications, and in-app messaging. It processes sensitive user communication data and personal preferences.
